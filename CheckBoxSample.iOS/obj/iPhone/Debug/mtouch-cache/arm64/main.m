...
extern void *mono_aot_module_CheckBoxSample_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_CheckBoxSample_info;
...
extern void *mono_aot_module_SaturdayMP_XPlugins_iOS_BEMCheckBox_info;
extern void *mono_aot_module_Calabash_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_CheckBoxSample_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_CheckBoxSample_info);
	...
	mono_aot_register_module (mono_aot_module_SaturdayMP_XPlugins_iOS_BEMCheckBox_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("SaturdayMP.XPlugins.iOS.BEMCheckBox.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "CheckBoxSample.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
