...
@class CheckBoxSample_iOS_CustomRendersiOS_CheckBoxRenderer;
...
@class SaturdayMP_XPlugins_iOS_BEMCheckBox__BEMCheckBoxDelegate;
@class SaturdayMP_XPlugins_iOS_BEMCheckBox_BEMCheckBoxAppearance;
@class BEMCheckBox;
...
@interface CheckBoxSample_iOS_CustomRendersiOS_CheckBoxRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end
...
@interface BEMCheckBoxDelegate : NSObject {
}
	-(id) init;
@end
...
@interface BEMCheckBoxGroup : NSObject {
	...
	-(void) addCheckBoxToGroup:(id)p0;
	-(void) removeCheckBoxFromGroup:(id)p0;
	-(BOOL) mustHaveSelection;
	-(void) setMustHaveSelection:(BOOL)p0;
	-(id) selectedCheckBox;
	-(void) setSelectedCheckBox:(id)p0;
	-(id) init;
@end

@interface SaturdayMP_XPlugins_iOS_BEMCheckBox_BEMCheckBoxAppearance : UIKit_UIControl_UIControlAppearance {
}
@end

@interface BEMCheckBox : UIControl {
}
	-(void) reload;
	...
	-(NSInteger) boxType;
	-(void) setBoxType:(NSInteger)p0;
	-(CGFloat) cornerRadius;
	-(void) setCornerRadius:(CGFloat)p0;
	-(id) group;
	-(BOOL) hideBox;
	-(void) setHideBox:(BOOL)p0;
	-(CGFloat) lineWidth;
	-(void) setLineWidth:(CGFloat)p0;
	-(CGSize) minimumTouchSize;
	-(void) setMinimumTouchSize:(CGSize)p0;
	-(NSInteger) offAnimationType;
	-(void) setOffAnimationType:(NSInteger)p0;
	-(UIColor *) offFillColor;
	-(void) setOffFillColor:(UIColor *)p0;
	-(BOOL) on;
	-(void) setOn:(BOOL)p0;
	-(NSInteger) onAnimationType;
	-(void) setOnAnimationType:(NSInteger)p0;
	-(UIColor *) onCheckColor;
	-(void) setOnCheckColor:(UIColor *)p0;
	-(UIColor *) onFillColor;
	-(void) setOnFillColor:(UIColor *)p0;
	-(UIColor *) onTintColor;
